...
public class ShowWaveformSnapshotAction extends Action {
    ...
    public ShowWaveformSnapshotAction(RTPlot plot, Composite composite) {
        super(composite.getVisible() ? Messages.HideSnapshotViewer : Messages.ShowSnapshotViewer, composite
                .getVisible() ? Activator.getDefault().getImageDescriptor("icons/up.gif") : Activator.getDefault()
                .getImageDescriptor("icons/down.gif"));
